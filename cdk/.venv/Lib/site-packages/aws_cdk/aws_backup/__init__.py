    ...
    class BackupRuleResourceTypeProperty:
        def __init__(
            ...
            *,
            ...
            :param schedule_expression_timezone: 
    ...
    class FrameworkControlProperty:
        def __init__(
            ...
            *,
            ...
            :param control_scope: The scope of a control. The control scope defines what the control will evaluate. Three examples of control scopes are: a specific backup plan, all backup plans with a specific tag, or all backup plans.
    ...
    class RestoreTestingRecoveryPointSelectionProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param algorithm: 
            :param include_vaults: 
            :param recovery_point_types: 
            :param exclude_vaults: 
            :param selection_window_days: 
...
class CfnRestoreTestingSelection(
    ...
    def __init__(
        ...
        *,
        ...
        :param id: Construct identifier for this resource (unique in its scope).
        :param iam_role_arn: 
        :param protected_resource_type: 
        :param restore_testing_plan_name: 
        :param restore_testing_selection_name: 
        :param protected_resource_arns: 
        :param protected_resource_conditions: 
        :param restore_metadata_overrides: 
        :param validation_window_hours: 
        '''
        if __debug__:
