    ...
    class EventSubscriptionProperty:
        def __init__(
            ...
            *,
            ...
            :param sns_topic_arn: Amazon Resource Name (ARN) of the Amazon Simple Notification Service topic. The format for this ARN is: ``arn:partition:sns:region:account:topic-name`` .
    ...
    class PhysicalResourceIdProperty:
        def __init__(
            ...
            *,
            ...
            :param aws_account_id: The account that owns the physical resource.
            :param aws_region: The that the physical resource is located in.
