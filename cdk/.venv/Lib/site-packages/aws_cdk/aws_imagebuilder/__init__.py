...
class CfnLifecyclePolicy(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: Scope in which this resource is defined.
        :param id: Construct identifier for this resource (unique in its scope).
        :param execution_role: The execution role of the lifecycle policy.
        :param name: The name of the lifecycle policy.
        :param policy_details: The policy details of the lifecycle policy.
        :param resource_selection: The resource selection for the lifecycle policy.
        :param resource_type: The resource type of the lifecycle policy.
        :param description: The description of the lifecycle policy.
        :param status: The status of the lifecycle policy.
        :param tags: The tags associated with the lifecycle policy.
        '''
        if __debug__:
