...
class NodejsFunction(
    ...
    def __init__(
        ...
        *,
        ...
        :param log_format: Sets the logFormat for the function. Default: Text format
        :param log_group: Sets the log group name for the function. Default: ``/aws/lambda/${this.functionName}`` default log group name created by Lambda
