...
class CfnCluster(
    ...
    def __init__(
        ...
        *,
        ...
        :param access_config: An object representing the Access Config to use for the cluster.
    ...
    class AccessConfigProperty:
        def __init__(
            ...
            *,
            ...
            :param authentication_mode: Specify the authentication mode that should be used to create your cluster.
            :param bootstrap_cluster_creator_admin_permissions: Set this value to false to avoid creating a default cluster admin Access Entry using the IAM principal used to create the cluster.
