    ...
    class AnalysisRuleCustomProperty:
        def __init__(
            ...
            *,
            ...
            :param allowed_analyses: The analysis templates that are allowed by the custom analysis rule.
            :param allowed_analysis_providers: The AWS accounts that are allowed to query by the custom analysis rule. Required when ``allowedAnalyses`` is ``ANY_QUERY`` .
