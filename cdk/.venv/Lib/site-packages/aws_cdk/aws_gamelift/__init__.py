...
class CfnFleet(
    ...
    def __init__(
        ...
        *,
        ...
        :param anywhere_configuration: Amazon GameLift Anywhere configuration options for your Anywhere fleets.
...
class CfnMatchmakingConfiguration(
    ...
    def __init__(
        ...
        *,
        ...
        :param creation_time: A time stamp indicating when this data object was created.
        ...
        :param rule_set_arn: The Amazon Resource Name (ARN) associated with the GameLift matchmaking rule set resource that this configuration uses.
...
class CfnScript(
    ...
    def __init__(
        ...
        *,
        ...
        :param tags: An array of key-value pairs to apply to this resource.
        :param version: The version that is associated with a script. Version strings do not need to be unique.
        '''
        if __debug__:
    ...
    class S3LocationProperty:
        def __init__(
            ...
            *,
            ...
            :param key: The name of the zip file that contains the script files.
