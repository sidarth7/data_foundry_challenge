    ...
    class CreateRuleProperty:
        def __init__(
            ...
            *,
            ...
            :param scripts: *[Snapshot policies that target instances only]* Specifies pre and/or post scripts for a snapshot lifecycle policy that targets instances. This is useful for creating application-consistent snapshots, or for performing specific administrative tasks before or after Amazon Data Lifecycle Manager initiates snapshot creation. For more information, see `Automating application-consistent snapshots with pre and post scripts <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/automate-app-consistent-backups.html>`_ .
    ...
    class CrossRegionCopyRuleProperty:
        def __init__(
            ...
            *,
            ...
            :param deprecate_rule: *[AMI policies only]* The AMI deprecation rule for cross-Region AMI copies created by the rule.
    ...
    class ParametersProperty:
        def __init__(
            ...
            *,
            ...
            :param exclude_data_volume_tags: *[Snapshot policies that target instances only]* The tags used to identify data (non-root) volumes to exclude from multi-volume snapshot sets. If you create a snapshot lifecycle policy that targets instances and you specify tags for this parameter, then data volumes with the specified tags that are attached to targeted instances will be excluded from the multi-volume snapshot sets created by the policy.
    ...
    class ScheduleProperty:
        def __init__(
            ...
            *,
            ...
            :param deprecate_rule: *[AMI policies only]* The AMI deprecation rule for the schedule.
    ...
    class ScriptProperty:
        def __init__(
            ...
            *,
            ...
            '''*[Snapshot policies that target instances only]* Information about pre and/or post scripts for a snapshot lifecycle policy that targets instances.
            ...
            :param execution_handler_service: Indicates the service used to execute the pre and/or post scripts. - If you are using custom SSM documents, specify ``AWS_SYSTEMS_MANAGER`` . - If you are automating VSS Backups, omit this parameter. Default: AWS_SYSTEMS_MANAGER
